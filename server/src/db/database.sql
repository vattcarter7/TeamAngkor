...
CREATE TABLE tours(
  ...
  name                          VARCHAR(200),
  description                   TEXT,
  private_1pax_price            INT NOT NULL,
  private_2pax_price            INT NOT NULL,
  private_3pax_price            INT NOT NULL,
  private_4pax_price            INT NOT NULL,
  private_5pax_price            INT NOT NULL,
  private_6pax_price            INT NOT NULL,
  private_7pax_price            INT NOT NULL,
  private_8pax_price            INT NOT NULL,
  private_9pax_price            INT NOT NULL,
  private_10pax_price           INT NOT NULL,
  private_11pax_price           INT NOT NULL,
  private_12pax_price           INT NOT NULL,
  private_13pax_price           INT NOT NULL,
  private_14pax_price           INT NOT NULL,
  private_15pax_price           INT NOT NULL,
  private_16pax_price           INT NOT NULL,
  private_17pax_price           INT NOT NULL,
  private_18pax_price           INT NOT NULL,
  private_19pax_price           INT NOT NULL,
  join_tour_price               INT NOT NULL,
  tokens                        tsvector,
  created_at                    TIMESTAMPTZ DEFAULT now(),
